...
public class Main {
    ...
    private static void generateDishCombo() {
        if (dc.checkingValues()){
            System.out.println("В меню нет блюд");
        } else {
            ...
            while (!nextItem.isEmpty()) { //варианты вводит пользователь
                if (dc.checkType(nextItem)) { //но вы должны проверить, существуют ли эти блюда в хранилище с помощью метода
                    // DinnerConstructor checkType
            ...
            ArrayList<ArrayList<String>> generatedCombos = dc.generateCombos(numberOfCombos, selectedTypes); //сгенерируйте варианты
